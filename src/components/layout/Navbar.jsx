        ...
        <div className="flex items-center justify-between h-16 lg:h-[72px]">
          ...
          <Link to="/" className="flex-shrink-0">
            <img 
              ...
              alt="MediEase" 
              className="h-10 sm:h-12 lg:h-14 w-auto object-contain transition-opacity hover:opacity-80"
            />
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-3 flex-shrink-0 ml-8">
            {/* Location */}
        ...
        <div className="lg:hidden pb-3">
          <div className="relative">
            ...
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full h-10 pl-10 pr-4 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-primary-red focus:ring-1 focus:ring-primary-red transition-all"
            />
          </div>
        </div>
          ...
          <div className="lg:hidden border-t border-gray-100 py-4 space-y-3">
            <div className="relative">
              ...
              <select
                value={location}
                onChange={(e) => setLocation(e.target.value)}
                className="w-full h-10 pl-9 pr-9 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 font-medium cursor-pointer appearance-none"
              >
                <option value="">Location</option>
                <option value="ny">New York</option>
                <option value="la">Los Angeles</option>
            ...
            <Link to="/login" className="block" onClick={() => setMobileMenuOpen(false)}>
              <button className="w-full h-10 bg-gradient-to-r from-[#FF7B7B] via-[#FF3333] via-[#DD0000] via-[#AA0000] to-[#660000] text-white text-sm font-semibold rounded-xl hover:shadow-lg transition-all">
                Login
              </button>
            </Link>
          </div>
