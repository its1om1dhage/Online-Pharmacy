      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-8">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-3">
            Upload your prescription and order medicines with ease and convenience
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 lg:p-12">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600">
            Simply upload your prescription and we'll process your order quickly and deliver it to your doorstep.
          </p>
        </div>
      </div>
    </div>
